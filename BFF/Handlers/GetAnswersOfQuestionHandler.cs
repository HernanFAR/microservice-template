...
{
    public class GetAnswersOfQuestionHandler : DelegatingHandler
    {
        private readonly AnswerHttpClient _AnswerClient;
        private readonly AnswerServiceConfiguration _Configuration;
        private readonly ILogger<GetAnswersOfQuestionHandler> _Logger;

        public GetAnswersOfQuestionHandler(AnswerHttpClient answerClient, AnswerServiceConfiguration configuration,
            ILogger<GetAnswersOfQuestionHandler> logger)
        {
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            return answers.SerializeAsJsonToHttpMessage(HttpStatusCode.OK);
        }
    }
}
